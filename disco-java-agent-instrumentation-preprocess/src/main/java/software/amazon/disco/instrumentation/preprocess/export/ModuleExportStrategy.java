...
public interface ModuleExportStrategy {
     ...
     */
    void export(final ModuleInfo info, final Map<String, InstrumentedClassState> instrumented, final InstrumentationState instrumentationState, final String suffix);
}
