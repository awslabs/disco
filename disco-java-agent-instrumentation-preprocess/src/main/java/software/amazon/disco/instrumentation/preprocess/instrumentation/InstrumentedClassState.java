...
/**
 * Class that encapsulates data of an instrumented class by ByteBuddy
 */
@Getter
public class InstrumentedClassState {
     ...
     */
    public InstrumentedClassState(final String installableId, final byte[] classBytes) {
