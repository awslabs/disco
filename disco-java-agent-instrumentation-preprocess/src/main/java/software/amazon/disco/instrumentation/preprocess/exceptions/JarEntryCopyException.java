 ...
 * fails to copy an exiting entry from the original Jar file.
 */
public class JarEntryCopyException extends RuntimeException {
    /**
     * Constructor
     *
     ...
     */
    public JarEntryCopyException(String entryName, Throwable cause) {
        super(PreprocessConstants.MESSAGE_PREFIX + "Failed to copy Jar entry: " + entryName, cause);
    }
}
