    ...
    private static File createJar(String name) throws Exception {
        ...
        try (FileOutputStream fileOutputStream = new FileOutputStream(file)) {
            try (JarOutputStream jarOutputStream = new JarOutputStream(fileOutputStream)) {
                ...
                jarOutputStream.putNextEntry(new ZipEntry("com/amazon/disco/agent/inject/"));
                jarOutputStream.putNextEntry(new ZipEntry("com/amazon/disco/agent/inject/InjectorTests$PremainClass.class"));
