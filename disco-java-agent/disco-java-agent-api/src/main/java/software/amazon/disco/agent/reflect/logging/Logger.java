...
public class Logger {
    ...
    static {
        log = ReflectiveCall.returning(software.amazon.disco.agent.logging.Logger.class)
    ...
    public static void debug (String s) {
        maybeAccept(software.amazon.disco.agent.logging.Logger.Level.DEBUG, s);
    }
    ...
    public static void info (String s) {
        maybeAccept(software.amazon.disco.agent.logging.Logger.Level.INFO, s);
    }
    ...
    public static void warn (String s) {
        maybeAccept(software.amazon.disco.agent.logging.Logger.Level.WARN, s);
    }
    ...
    public static void error(String s) {
        maybeAccept(software.amazon.disco.agent.logging.Logger.Level.ERROR, s);
    }
     ...
     * @param s the message
     */
    static void maybeAccept(software.amazon.disco.agent.logging.Logger.Level level, String s) {
