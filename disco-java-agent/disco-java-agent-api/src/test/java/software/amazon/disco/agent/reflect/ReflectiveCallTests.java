...
public class ReflectiveCallTests {
    ...
    public void testBeanGetters() {
        ...
        Assert.assertEquals("software.amazon.disco.agent.Foo", call.getClassName());
    ...
    public void testToString() {
        ...
        Assert.assertEquals("java.lang.Long software.amazon.disco.agent.package.Foo::Bar(java.lang.Integer, java.lang.Boolean)", call.toString());
    }
