...
import com.amazon.disco.agent.plugin.source.PluginInit;
import com.amazon.disco.agent.plugin.source.PluginListener;
...
public class PluginDiscoveryTests {
    ...
    public void testPluginInitClassNonBootstrap() throws Exception {
        createJar("plugin_with_init",
                "Disco-Init-Class: com.amazon.disco.agent.plugin.source.PluginInit",
                "com.amazon.disco.agent.plugin.source.PluginInit");
    ...
    public void testPluginListenerNonBootstrap() throws Exception {
        createJar("plugin_with_listener",
                "Disco-Listener-Classes: com.amazon.disco.agent.plugin.source.PluginListener",
                "com.amazon.disco.agent.plugin.source.PluginListener");
        List<PluginOutcome> outcomes = PluginDiscovery.init(instrumentation, installables, agentConfig);
    ...
    public void testPluginInstallableNonBootstrap() throws Exception {
        createJar("plugin_with_installable",
                "Disco-Installable-Classes: com.amazon.disco.agent.plugin.source.PluginInstallable",
                "com.amazon.disco.agent.plugin.source.PluginInstallable");
        List<PluginOutcome> outcomes = PluginDiscovery.init(instrumentation, installables, agentConfig);
